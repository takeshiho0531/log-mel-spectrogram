...
module TB_SPI;
    ...
    spi_logic spi_inst (
        ...
        .sys_clk_i(sys_clk),
        .rst_n_i(rst),
        .rst_for_logmel_i(rst_log),
        .spi_clk_i(spi_clk),
        .spi_cs_i(spi_cs),
        .spi_mosi_i(spi_mosi),
        .spi_miso_o(spi_miso),
        .spi_miso_en_o(spi_miso_en),
        .REG_IN_A_000_o(REG_IN_A_000),
        .REG_IN_A_001_o(REG_IN_A_001),
        .REG_IN_A_002_o(REG_IN_A_002),
        .REG_IN_A_003_o(REG_IN_A_003),
        .REG_IN_A_004_o(REG_IN_A_004),
        .REG_IN_A_005_o(REG_IN_A_005),
        .REG_IN_A_006_o(REG_IN_A_006),
        .REG_IN_A_007_o(REG_IN_A_007),
        .REG_IN_A_008_o(REG_IN_A_008),
        .REG_IN_A_009_o(REG_IN_A_009),
        .REG_IN_A_010_o(REG_IN_A_010),
        .REG_IN_A_011_o(REG_IN_A_011),
        .REG_IN_A_012_o(REG_IN_A_012),
        .REG_IN_A_013_o(REG_IN_A_013),
        .REG_IN_A_014_o(REG_IN_A_014),
        .REG_IN_A_015_o(REG_IN_A_015),
        .REG_IN_A_016_o(REG_IN_A_016),
        .REG_IN_A_017_o(REG_IN_A_017),
        .REG_IN_A_018_o(REG_IN_A_018),
        .REG_IN_A_019_o(REG_IN_A_019),
        .REG_IN_A_020_o(REG_IN_A_020),
        .REG_IN_A_021_o(REG_IN_A_021),
        .REG_IN_A_022_o(REG_IN_A_022),
        .REG_IN_A_023_o(REG_IN_A_023),
        .REG_IN_A_024_o(REG_IN_A_024),
        .REG_IN_A_025_o(REG_IN_A_025),
        .REG_IN_A_026_o(REG_IN_A_026),
        .REG_IN_A_027_o(REG_IN_A_027),
        .REG_IN_A_028_o(REG_IN_A_028),
        .REG_IN_A_029_o(REG_IN_A_029),
        .REG_IN_A_030_o(REG_IN_A_030),
        .REG_IN_A_031_o(REG_IN_A_031),
        .REG_IN_A_032_o(REG_IN_A_032),
        .REG_IN_A_033_o(REG_IN_A_033),
        .REG_IN_A_034_o(REG_IN_A_034),
        .REG_IN_A_035_o(REG_IN_A_035),
        .REG_IN_A_036_o(REG_IN_A_036),
        .REG_IN_A_037_o(REG_IN_A_037),
        .REG_IN_A_038_o(REG_IN_A_038),
        .REG_IN_A_039_o(REG_IN_A_039),
        .REG_IN_A_040_o(REG_IN_A_040),
        .REG_IN_A_041_o(REG_IN_A_041),
        .REG_IN_A_042_o(REG_IN_A_042),
        .REG_IN_A_043_o(REG_IN_A_043),
        .REG_IN_A_044_o(REG_IN_A_044),
        .REG_IN_A_045_o(REG_IN_A_045),
        .REG_IN_A_046_o(REG_IN_A_046),
        .REG_IN_A_047_o(REG_IN_A_047),
        .REG_IN_A_048_o(REG_IN_A_048),
        .REG_IN_A_049_o(REG_IN_A_049),
        .REG_IN_A_050_o(REG_IN_A_050),
        .REG_IN_A_051_o(REG_IN_A_051),
        .REG_IN_A_052_o(REG_IN_A_052),
        .REG_IN_A_053_o(REG_IN_A_053),
        .REG_IN_A_054_o(REG_IN_A_054),
        .REG_IN_A_055_o(REG_IN_A_055),
        .REG_IN_A_056_o(REG_IN_A_056),
        .REG_IN_A_057_o(REG_IN_A_057),
        .REG_IN_A_058_o(REG_IN_A_058),
        .REG_IN_A_059_o(REG_IN_A_059),
        .REG_IN_A_060_o(REG_IN_A_060),
        .REG_IN_A_061_o(REG_IN_A_061),
        .REG_IN_A_062_o(REG_IN_A_062),
        .REG_IN_A_063_o(REG_IN_A_063),
        .logmel_do_en(do_en),
        .logmel_data_o(logmel_data_o),


        .REG_IN_B_000_o(REG_IN_B_000),
        .REG_OUT_A_000_i(REG_OUT_A_000),
        .REG_OUT_B_000_i(REG_OUT_B_000)
    );
